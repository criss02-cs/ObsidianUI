...
{
	public static BindableProperty IncaveColorProperty => 
	...
	public Color IncaveColor { get => (Color)GetValue(IncaveColorProperty); set => SetValue(IncaveColorProperty, value); }
	...
	public int ProgressThickness { get => (int)GetValue(ProgressThicknessProperty); set => SetValue(ProgressThicknessProperty, value); }
